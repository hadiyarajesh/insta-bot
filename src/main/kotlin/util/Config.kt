...
object HTTP {
    ...
    val HEADERS = mutableMapOf(
        ...
        "X-Pigeon-Session-Id" to Crypto.generateTemporaryGUID(
            "pigeonSessionId",
            InstagramAPI.uuid,
            1200000f
        ),
        "X-Pigeon-Rawclienttime" to "%.3f".format(System.currentTimeMillis() / 1000f),
        "X-IG-Capabilities" to "IT7nCQ==",
        "X-IG-App-ID" to "567067343352427",
        "X-IG-Connection-Type" to "WIFI",
        "X-IG-Prefetch-Request" to "foreground",
        "X-IG-VP9-Capable" to "false",
...
// Enum class for direct messaging items
enum class ITEMTYPE {
    TEXT,
    MEDIA,
    HASHTAG,
...
object Routes {
    ...
    fun contactPointPrefill() = "accounts/contact_point_prefill/"

    fun login(): String = "accounts/login/"

    fun logout(): String = "accounts/logout/"

    fun reelsTrayFeed(): String = "feed/reels_tray/"

    fun suggestedSearches(): String = "fbsearch/suggested_searches/"

    fun rankedRecipients(): String = "direct_v2/ranked_recipients/"

    fun loomFetchConfig(): String = "loom/fetch_config/"

    fun profileNotice(): String = "users/profile_notice/"

    fun batchFetch(): String = "qp/batch_fetch/"

    fun twoFactorAuth(): String = "accounts/two_factor_login/"

    fun userTags(userId: String, rankToken: String): String =
        "usertags/${userId}/feed/?rank_token=${rankToken}&ranked_content=true"

    fun geoMedia(userId: String): String = "maps/user/${userId}/"

    fun follow(userId: String): String = "friendships/create/${userId}/"

    fun unfollow(userId: String): String = "friendships/destroy/${userId}/"

    fun removeFollower(userId: String): String = "friendships/remove_follower/${userId}"

    fun expose(): String = "qe/expose/"

    fun explore(): String = "discover/explore/"

    fun saveMedia(mediaId: String): String = "media/${mediaId}/save/"

    fun unsaveMedia(mediaId: String): String = "media/${mediaId}/unsave/"

    fun getSavedMedia(): String = "feed/saved/"

    fun igtvSuggestions(): String = "igtv/tv_guide/"

    fun setAccountPrivate(): String = "accounts/set_private/"

    fun setAccountPublic(): String = "accounts/set_public/"

    fun editAccount(): String = "accounts/edit_profile/"

    fun profileData(): String = "accounts/current_user/?edit=true"

    fun setNameAndPhone(): String = "accounts/set_phone_and_name/"

    fun comment(mediaId: String): String = "media/${mediaId}/comment/"

    fun deleteComment(mediaId: String, commentId: String) = "media/${mediaId}/comment/${commentId}/delete/"

    fun commentLikers(commentId: String): String = "media/${commentId}/comment_likers/?"

    fun mediaLikers(mediaId: String): String = "media/${mediaId}/likers/?"

    fun likeComment(commentId: String): String = "media/${commentId}/comment_like/"

    fun unlikeComment(commentId: String): String = "media/${commentId}/comment_unlike/"

    fun like(mediaId: String): String = "media/${mediaId}/like/"

    fun unlike(mediaId: String): String = "media/${mediaId}/unlike/"

    fun userFriendship(userId: String): String = "friendships/show/${userId}/"

    fun userInfoById(userId: String): String = "users/${userId}/info/"

    fun userInfoByName(username: String): String = "users/${username}/usernameinfo/"

    fun userFeed(userId: String, maxId: String, minTimeStamp: String, rankToken: String): String =
        "feed/user/${userId}/?max_id=${maxId}&min_timestamp=${minTimeStamp}&rank_token=${rankToken}&ranked_content=true"

    fun userStories(userId: String): String = "feed/user/${userId}/story/"

    fun timeline(maxId: String = ""): String = "feed/timeline/?max_id=${maxId}"

    fun hashTagFeed(hashTag: String, maxId: String = "", rankToken: String): String =
        "feed/tag/${hashTag}/?max_id=${maxId}&rank_token=${rankToken}&ranked_content=true"

    fun likedFeed(maxId: String): String = "feed/liked/?max_id=${maxId}"

    fun locationFeed(locationId: String, maxId: String, rankToken: String): String =
        "feed/location/${locationId}/?max_id=${maxId}&rank_token=${rankToken}&ranked_content=true"

    fun popularFeed(rankToken: String): String =
        "feed/popular/?people_teaser_supported=1&rank_token=${rankToken}&ranked_content=true"

    fun userFollowings(userId: String, maxId: String = "", rankToken: String): String =
        "friendships/${userId}/following/?max_id=${maxId}&ig_sig_key_version=${KEY.SIG_KEY_VERSION}&rank_token=${rankToken}"

    fun userFollowers(userId: String, maxId: String = "", rankToken: String): String =
        "friendships/${userId}/followers/?max_id=${maxId}&ig_sig_key_version=${KEY.SIG_KEY_VERSION}&rank_token=${rankToken}"

    fun changePassword(): String = "accounts/change_password/"

    fun removeProfilePicture(): String = "accounts/remove_profile_picture/"

    fun searchUser(userName: String, rankToken: String): String =
        "users/search/?ig_sig_key_version=${KEY.SIG_KEY_VERSION}&is_typehead=true&query=${userName}&rank_token=${rankToken}"

    fun searchHashTag(hashTagName: String, amount: Int, rankToken: String): String =
        "tags/search/?count=${amount}&is_typeahead=true&q=${hashTagName}&rank_token=${rankToken}"

    fun hashTagStories(hashTag: String): String = "tags/${hashTag}/story/"

    fun hashTagSelection(hashTag: String): String = "tags/${hashTag}/sections/"

    fun mediaInsight(mediaId: String): String =
        "insights/media_organic_insights/${mediaId}/?ig_sig_key_version=${KEY.SIG_KEY_VERSION}"

    fun selfInsight(): String = "insights/account_organic_insights/?show_promotions_in_landing_page=true&first="

    fun followHashTag(hashTag: String): String = "tags/follow/${hashTag}/"

    fun unfollowHashTag(hashTag: String): String = "tags/unfollow/${hashTag}/"

    fun tagsFollowedByUser(userId: String): String = "users/${userId}/following_tags_info/"

    fun searchLocation(locationName: String, amount: Int, rankToken: String): String =
        "fbsearch/places/?count=${amount}&query=${locationName}&rank_token=${rankToken}"

    fun mediaInfo(mediaId: String): String = "media/${mediaId}/info/"

    fun editMedia(mediaId: String): String = "media/${mediaId}/edit_media/"

    fun deleteMedia(mediaId: String): String = "media/${mediaId}/delete/"

    fun removeSelfTagFromMedia(mediaId: String): String = "media/${mediaId}/remove/"

    fun archiveMedia(mediaId: String, action: String, mediaType: Int): String =
        "media/${mediaId}/${action}/?media_type=${mediaType}"

    fun mediaComments(mediaId: String, maxId: String = ""): String = "media/${mediaId}/comments/?max_id=${maxId}"

    fun qeSync(): String = "qe/sync/"

    fun launcherSync(): String = "launcher/sync/"

    fun inboxV2(): String = "direct_v2/inbox/?"

    fun presence(): String = "direct_v2/get_presence/"

    fun userReel(userId: String): String = "feed/user/${userId}/reel_media/"

    fun selfStoryViewers(storyId: String): String =
        "media/${storyId}/list_reel_media_viewer/?supported_capabilities_new=${EXPERIMENTS.SUPPORTED_CAPABILITIES}"

    fun watchReels(): String = "media/seen/"

    fun multipleUsersReel(): String = "feed/reels_media/"

    fun pendingInbox(): String = "direct_v2/pending_inbox/?persistentBadging=true&use_unified_inbox=true"

    fun directItem(itemType: String): String = "direct_v2/threads/broadcast/${itemType}/"

    fun directPhoto(): String = "direct_v2/threads/broadcast/upload_photo/"

    fun approvePendingThread(threadId: String): String = "direct_v2/threads/${threadId}/approve/"

    fun hidePendingThread(threadId: String): String = "direct_v2/threads/${threadId}/hide/"

    fun declinePendingThread(threadId: String): String = "direct_v2/threads/${threadId}/decline/"

    fun autoCompleteUserList(): String = "friendships/autocomplete_user_list/?version=2&followinfo=True"

    fun megaphoneLog(): String = "megaphone/log/"

    fun block(userId: String): String = "friendships/block/${userId}/"

    fun unblock(userId: String): String = "friendships/unblock/${userId}/"

    fun recentActivity(): String = "news/inbox/"

    fun muteUser(): String = "friendships/mute_posts_or_story_from_follow/"

    fun getMutedUser(): String = "friendships/muted_reels"

    fun unmuteUser(): String = "friendships/unmute_posts_or_story_from_follow/"

    fun pendingFriendRequests(): String = "friendships/pending/"

    fun approvePendingFollowRequest(userId: String): String = "friendships/approve/${userId}/"

    fun rejectPendingFollowRequest(userId: String): String = "friendships/ignore/${userId}/"

    fun directShare(): String = "direct_share/inbox/"
}